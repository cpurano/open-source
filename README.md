**Информационно-аналитическая система «Мониторинг текущей деятельности организации»**, разработанная компанией «Инфосистемы Джет» в сотрудничестве с Центром перспективных управленческих решений (ЦПУР), предназначена для формирования и визуализации аналитических показателей деятельности организации.

Система мониторинга эффективности решает задачу оперативного сбора данных и подготовки интерактивных аналитических отчетов о деятельности организации. Это позволяет руководителям организаций в несколько кликов получить аналитические сводки с возможностью детализации до первичного документа. 
